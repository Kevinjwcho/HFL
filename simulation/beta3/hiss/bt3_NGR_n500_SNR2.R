...
load("~/Desktop/simulation/beta3/NGR/bt3_ss_n500_SNR2.RData") # change
...
save(alpha_gbr_AIC2, tau_gbr_AIC2, alpha_gbr_BIC2, tau_gbr_BIC2, 
     b_gbr_AIC2, b_gbr_BIC2, file="bt3_NGR_n500_SNR2.RData")     
...
beta_hat_gbr_T1 = apply(b_gbr_BIC2[,1:20], 2, FUN = betahat)
