rm(list=ls())
setwd("~/Desktop/simulation/beta2/NGR") # change
library(psych)
library(fda)
library(glmnet)
...
load("~/Desktop/simulation/beta2/NGR/bt2_ss_n500_SNR2.RData") # change
...
load("~/Desktop/simulation/datafunction/dataSNR2.RData") # change
...
save(alpha_gbr_AIC2, tau_gbr_AIC2, alpha_gbr_BIC2, tau_gbr_BIC2, 
     b_gbr_AIC2, b_gbr_BIC2, file="bt2_NGR_n500_SNR2.RData")     
