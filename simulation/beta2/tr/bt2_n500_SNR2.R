...
setwd("~/Desktop/simulation/beta2/tr") # change
...
#save.image(file = "beta2_100.RData")
save(thetabest0, thetabest1, betaest0, betaest1, mchoice0,lambdachoice0,
     lambdachoice1, aest0, aest1, mod1ferr, psis, designs, file = "beta2_500_SNR2.RData")
